...
/**
 * Return Promise object that is resolved with string
 * value === 'Hooray!!! She said "Yes"!', * if boolean value === true is passed,
 * resolved with string value === 'Oh no, she said "No".', *
 * if boolean value === false is passed, and rejected
 * with error message === 'Wrong parameter is passed!
...
function chainPromises(array, action) {
  ...
  return new Promise((resolve) => {
    array.map((el) => el.then((res) => output.push(res))
